...
public class GetUpdatesMethod implements ListBotMethodDefinition<Update> {
     ...
     * Defaults to 0, i.e. usual short polling. Should be positive, short polling should be used for testing purposes
     * only.
     */
    ...
    @Override
    public TypeReference<GenericBotApiResponse<List<Update>>> getResponseClass() {
